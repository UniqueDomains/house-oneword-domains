...
This dictionary describes the columns exported in `house.csv` and `house.json`.
...
| status_verified_at | datetime or null           | When status was last established against the registry. Null means never checked. |
